...
RESULT_COLUMNS = (
    ...
    ResultColumn("execution_shard_count", "integer"),
    ResultColumn("execution_shard_indices"),
    ResultColumn("execution_shard_index", "integer"),
    ResultColumn("execution_shard_policy"),
    ...
    ResultColumn("factor_c"),
    ResultColumn("factor_amo"),
    ResultColumn("status"),
    ResultColumn("sat_result"),
    ResultColumn("best_value", "integer"),
    ResultColumn("proven_optimum", "integer"),
    ResultColumn("objective_mode"),
    ResultColumn("compact_encoding"),
    ResultColumn("compact_encoding_features"),
    ResultColumn("participant_idle_cap_rule"),
    ResultColumn("participant_idle_cap_alpha"),
    ResultColumn("participant_idle_lower_bounds"),
    ResultColumn("participant_idle_upper_bounds"),
    ResultColumn("participant_idle_caps"),
    ResultColumn("participant_idle_bounds_feasible", "boolean"),
    ResultColumn("participant_idle_cap_clause_count", "integer"),
    ResultColumn("collision_amo"),
    ResultColumn("collision_amo_cutoff", "integer"),
    ResultColumn("collision_amo_commander_group_size", "integer"),
    ResultColumn("collision_amo_pairwise_group_count", "integer"),
    ResultColumn("collision_amo_commander_group_count", "integer"),
    ResultColumn("collision_amo_commander_variable_count", "integer"),
    ResultColumn("collision_amo_clause_count", "integer"),
    ResultColumn("collision_amo_max_group_size", "integer"),
    ResultColumn("zero_break_certificate_participant", "integer"),
    ResultColumn("zero_break_certificate_reason"),
    ResultColumn("zero_break_branch"),
    ...
    ResultColumn("model_family_display_name"),
    ResultColumn("model_configuration_display_name"),
    ResultColumn("implementation_provenance"),
    ResultColumn("optimization_procedure_display_name"),
    ...
    ResultColumn("max_soft_weight_bits", "integer"),
    ResultColumn("n_objective_lits", "integer"),
    ResultColumn("occupancy_alias_count", "integer"),
    ResultColumn("prefix_alias_count", "integer"),
    ResultColumn("suffix_alias_count", "integer"),
    ResultColumn("first_alias_count", "integer"),
    ResultColumn("shared_counter_state_count", "integer"),
    ResultColumn("direct_range_soft_clause_count", "integer"),
    ...
    ResultColumn("maximum_internal_idle_slots", "integer"),
    ResultColumn("squared_internal_idle_slots", "integer"),
...
README_ROWS = (
    ...
    (
        "Configuration key",
        "configuration_id/configuration_key contains the M/F/P/G/B/O/S/I/C "
